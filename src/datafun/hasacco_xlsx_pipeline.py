...
Date: 2026-04
  ...
  Paths (relative to repo root):
    ...
    INPUT FILE:  data/raw/Math_STAAR_data.xlsx
    OUTPUT FILE: data/processed/xlsx_STAAR_gender_count.txt

  Terminal command to run this file from the root project folder:

    uv run python -m datafun.hasacco_xlsx_pipeline
...
def run_xlsx_pipeline(*, raw_dir: Path, processed_dir: Path, logger: Any) -> None:
    ...
    input_file = raw_dir / "Math_STAAR_data.xlsx"
    output_file = processed_dir / "xlsx_STAAR_gender_count.txt"
