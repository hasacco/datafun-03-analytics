...
Terminal command to run this file from the root project folder:
    ...
    uv run python -m datafun.app_hasacco_score_analysis
...
# from datafun.hasacco_csv_pipeline import run_csv_pipeline
# from datafun.hasacco_json_pipeline import run_json_pipeline
# from datafun.hasacco_text_pipeline import run_text_pipeline
from datafun.hasacco_xlsx_pipeline_all_scores import run_xlsx_pipeline
from datafun.hasacco_xlsx_pipeline_scores_ELL import run_xlsx_pipeline_ELL
...
def main() -> None:
    ...
    run_xlsx_pipeline_ELL(raw_dir=RAW_DIR, processed_dir=PROCESSED_DIR, logger=LOG)
